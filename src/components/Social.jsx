            ...
            <div className={`flex gap-2 lg:flex-row shrink-0 grow-0 flex-wrap ${vertical ? "flex-col items-start" : "items-center"}`}>
                <div className="flex gap-2">
                    <Link to="https://facebook.com/GediminoJasenophotography">
                        <img src={IMAGES.fb} alt="facebook" className={`hover:opacity-85`} style={{ width: size, filter: "invert(23%) sepia(78%) saturate(2124%) hue-rotate(358deg) brightness(83%) contrast(94%)" }} />
                    </Link>
                    <Link to="https://m.me/GediminoJasenophotography">
                        <img src={IMAGES.msg} alt="messenger" className={`hover:opacity-85`} style={{ width: size, filter: "invert(23%) sepia(78%) saturate(2124%) hue-rotate(358deg) brightness(83%) contrast(94%)" }} />
                    </Link>
                    <Link to="https://www.instagram.com/gedimino_jaseno_fotografija/">
                        <img src={IMAGES.ig} alt="instagram" className={`hover:opacity-85`} style={{ width: size, filter: "invert(23%) sepia(78%) saturate(2124%) hue-rotate(358deg) brightness(83%) contrast(94%)" }} />
                    </Link>
                </div>
                <div className="flex gap-2">
                    <div className="transition-all flex">
                        ...
                        <button onClick={handleMail}>
                            <img src={IMAGES.mail} alt="email" style={{width: size}} className={`hover:opacity-85 bg-custom-red transition-all duration-300 ${showMail ? "rounded-r-full" : "rounded-full delay-200"}`} />
                        </button>
                    </div>
                    <div className="transition-all flex">
                        ...
                        <button onClick={handlePhone}>
                            <img src={IMAGES.phone} alt="email" style={{width: size}} className={`hover:opacity-85 bg-custom-red transition-all duration-300 ${showPhone ? "rounded-r-full" : "rounded-full delay-200"}`} />
                        </button>
                    </div>
                </div>
            </div>
